    ...
    <div class="container">
      <div class="row">
        ...
        <div class="form-group last mb-4">
          ...
          <input type="password" class="form-control" name="senha2" id="senha2" onblur="validarSenha()">
        </div>
			  
        <input type="submit" value="Cadastrar" class="btn text-white btn-block btn-primary botao">
		 <input type="submit" value="Voltar" class="btn text-white btn-block btn-success botao">
